...
ADD FOREIGN KEY(`foreman_id`) REFERENCES `workers`(`worker_id`),
...
('Bisdak', 'Kayngdako', 'cebunumbawan@cebu.gov.ph', '09223344556', '358G Uranus Avenue, Mandaue City'),
