            ...
            <?php if($workers): ?>
              <?php foreach($workers as $key => $value): ?>
                <tr>
                  ...
                  <td><?=date("F j, Y", strtotime($value->hire_date))?></td>
                  <td><?=$value->salary?></td>
                  <td class="text-truncate"><?=$value->street_address.", ".$value->city?></td>
                  <td><a href="#"><span data-feather="edit" class="align-text-bottom"></span></a></td>
                </tr>
              <?php endforeach; ?>
            <?php endif; ?>
          </tbody>
