...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
				<div class="position-sticky pt-3 sidebar-sticky">
					...
					<ul class="nav flex-column mb-2">
						...
						<li class="nav-item">
							<a class="nav-link active" href="<?=ROOT?>/locations">
 ...
 <form method ="post" action = "insertlocation"> 
          <div class="input-group">
            ...
            <input type="text" aria-label="First name" name ="postal_code" class="form-control">
          </div>
          <br>
          <div class="input-group">
          ...
          {	 
            ...
            $sql = "INSERT INTO `locations` (postal_code,city,state_province,country_id)
            VALUES ('$postal_code','$city','$state_province','$country_id')";
